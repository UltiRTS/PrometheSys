...
class State {
  constructor(storage) {
    // this.promethesys.chat.chatLog={};
    this.promethesys={
      chats: {
        chatsIndex: {},
        joinedChats: [],
        chatThatNeedsToBeUpdated: {},
        channelLastAuthor: {},
      },
      sys: {
        username: '',
  ...
  updatePoll(gameID, pollKeyName, pollKeyValue) {
    ...
    if (game) {
      game.polls[pollKeyName]=pollKeyValue;
    }
  }

  getGameByID(id) {
    for (const game in this.promethesys.game) {
      if (this.promethesys.game[game].id==id) {
        return this.promethesys.game[game];
      }
    }
    return null;
  }
